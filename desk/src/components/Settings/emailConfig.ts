...
export const services: EmailService[] = [
  {
    name: "GMail",
    icon: LogoGmail,
    info: 'Setting up GMail requires you to enable two factor authentication and app specific passwords. Read more',
  ...
  },
  {
    name: "Outlook",
    icon: LogoOutlook,
    info: 'Setting up Outlook requires you to enable two factor authentication and app specific passwords. Read more',
  ...
  },
  {
    name: "Sendgrid",
    icon: LogoSendgrid,
    info: 'Setting up Sendgrid requires you to enable two factor authentication and app specific passwords. Read more',
  ...
  },
  {
    name: "SparkPost",
    icon: LogoSparkpost,
    info: 'Setting up SparkPost requires you to enable two factor authentication and app specific passwords. Read more',
  ...
  },
  {
    name: "Yahoo",
    icon: LogoYahoo,
    info: 'Setting up Yahoo requires you to enable two factor authentication and app specific passwords. Read more',
  ...
  },
  {
    name: "Yandex",
    icon: LogoYandex,
    info: 'Setting up Yandex requires you to enable two factor authentication and app specific passwords. Read more',
