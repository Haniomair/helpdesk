...
import { EChartsOption, init, registerLocale } from 'echarts'
import langAR from 'echarts/i18n/langAR-obj';
...
onMounted(() => {
  ...
  chart = init(chartDiv.value, 'light', { renderer: 'svg', locale: getCurrentLanguage() })
